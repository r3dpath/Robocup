...
void QuadEncodersInit(QuadEncoder channel1, QuadEncoder channel2) {
    // Channel 1 setup
    channel1.setInitConfig();
    channel1.EncConfig.revolutionCountCondition = ENABLE;
    channel1.EncConfig.enableModuloCountMode = ENABLE;
    channel1.EncConfig.positionModulusValue = 20;
    channel1.init();

    // Channel 2 setup
    channel2.setInitConfig();  //
    channel2.EncConfig.revolutionCountCondition = ENABLE;
    channel2.EncConfig.enableModuloCountMode = ENABLE;
    channel2.EncConfig.positionModulusValue = 20;
    channel2.init();
}
